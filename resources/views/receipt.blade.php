    ...
    <style type="text/css">
        ...
        @media screen and (max-width: 600px) {
            ...
            *[class="Gmail"] {
            ...
            .Header-left {
                background-image: url('{{ asset('/vendor/cashier/img/invoice/Left.png') }}') !important;
            }

            .Header-right {
                background-image: url('{{asset('/vendor/cashier/img/invoice/Right.png')}}') !important;
            ...
            .Header-icon {
                width: 96px !important;
                height: 156px !important;
                background-image: url('{{ asset('/vendor/cashier/img/invoice/twelve_degree_icon.png') }}') !important;
                    ...
                    <table dir="ltr" class="Section Header" width="100%"
                        ...
                        <tr>
                            <td class="Header-left Target"
                                ...
                                <a href="#" style="pointer-events: none;">
                                    <img alt="" height="156" width="252"
                                         src="{{ asset('/vendor/cashier/img/invoice/Left.png') }}"
                                ...
                                <a href="{{ route('home') }}"
                                   style="-webkit-font-smoothing: antialiased;-moz-osx-font-smoothing: grayscale;outline: 0;text-decoration: none;">
                                    <img alt="" height="156" width="96"
                                         src="{{ asset('/vendor/cashier/img/invoice/twelve_degree_icon.png') }}"
                                         style="display: block;border: 0;line-height: 100%;width: 100%;"/>
                                </a>
                            </td>
                            <td class="Header-right Target"
                                ...
                                <a href="#" style="pointer-events: none;">
                                    <img alt="" height="156" width="252"
                                         src="{{ asset('/vendor/cashier/img/invoice/Right.png') }}"
                                         style="display: block;border: 0;line-height: 100%;width: 100%;">
                                </a>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="Content Footer-legal Font Font--caption Font--mute"
                                ...
                                Something wrong with the email? <a class="browser-link"
                                                                   href="{{ route('cashier.receipt', $payment->id) }}"
